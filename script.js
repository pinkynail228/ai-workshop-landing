...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const motionTier = (isMobile || prefersReducedMotion) ? "lite" : "rich";
    const body = document.body;
    const heroVideo = document.querySelector(".hero-video");
    const revealTargets = document.querySelectorAll(".reveal-on-scroll");

    body.classList.remove("motion-desktop-rich", "motion-mobile-lite", "mobile-optimized");
    body.classList.add(motionTier === "rich" ? "motion-desktop-rich" : "motion-mobile-lite");
    ...
    if (prefersReducedMotion) {
        ...
        const revealOptions = motionTier === "rich"
